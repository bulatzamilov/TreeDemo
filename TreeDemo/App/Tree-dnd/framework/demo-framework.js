    ...
    [
        ...
        function ($routeProvider) {
            $routeProvider
                .when(
                '/tree-dnd', {
                    templateUrl: '/App/Tree-dnd/basic/basic-frame.html',
                ...
                .when(
                '/tree-dnd/filter', {
                    templateUrl: '/App/Tree-dnd/filter/filter-frame.html',
                    controller:  'FilterController'
                }
            )
                .when(
                '/tree-dnd/list', {
                    templateUrl: '/App/Tree-dnd/list/list-frame.html',
                    controller:  'ListController'
                }
            )
                .when(
                '/tree-dnd/multi', {
                    templateUrl: '/App/Tree-dnd/multi/multi-frame.html',
                    controller:  'MultiController'
                }
            )
                .when(
                '/tree-dnd/custom-options', {
                    templateUrl: '/App/Tree-dnd/custom/custom-frame.html',
                    controller:  'CustomController'
                }
            )
                .otherwise({ redirectTo: '/tree-dnd' });
        }]
).
    directive(
